...
class DeckForestSnapshotIndexCacheDefinition final
    : public IndexCacheDefinition<
          Domain::DeckForestSnapshotIndex,
...
public:
    ...
    explicit DeckForestSnapshotIndexCacheDefinition(
        const DeckForestSnapshotIndexCacheDefinition&
    ) = delete;
    DeckForestSnapshotIndexCacheDefinition&
    operator=(const DeckForestSnapshotIndexCacheDefinition&) = delete;

    explicit DeckForestSnapshotIndexCacheDefinition(
        DeckForestSnapshotIndexCacheDefinition&&
    ) = delete;
    DeckForestSnapshotIndexCacheDefinition&
    operator=(DeckForestSnapshotIndexCacheDefinition&&) = delete;
