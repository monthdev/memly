...
[[nodiscard]] auto M00_CreateMigrationsLogSql() -> std::string {
    return Support::Runtime::QtApp::ReadQtAppResourceBytes(":/Sql/Migration/Statement/M00_CreateMigrationsLog.sql");
}

[[nodiscard]] auto M01_CreateSchemaSql() -> std::string {
    return Support::Runtime::QtApp::ReadQtAppResourceBytes(":/Sql/Migration/Statement/M01_CreateSchema.sql");
}
