...
void RuntimeContext::Initialize(const std::string& DatabaseFilePath) {
    ...
    // s_LibraryClockStore = std::make_unique<Infrastructure::Store::Library::LibraryClockStore>(*s_DatabaseRuntime);
    ...
    s_DeckStore = std::make_unique<Infrastructure::Store::Deck::DeckStore>(*s_DatabaseRuntime);
    s_DeckSnapshotStore = std::make_unique<Infrastructure::Store::Deck::DeckSnapshotStore>(*s_DatabaseRuntime);
    // s_ReviewSessionListStore = std::make_unique<Infrastructure::Store::ReviewSession::ReviewSessionListStore>(*s_DatabaseRuntime);
    // s_ReviewSessionStore = std::make_unique<Infrastructure::Store::ReviewSession::ReviewSessionStore>(*s_DatabaseRuntime);
