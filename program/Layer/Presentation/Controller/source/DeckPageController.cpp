...
DeckPageController::DeckPageController(Invalidation::LibraryInvalidationChannel& LibraryInvalidationChannel,
    ...
    LibraryInvalidationChannel.ConnectSnapshot(
        this, Invalidation::LibraryInvalidationTargetEnum::DeckForestSnapshot, &DeckPageController::RefreshDeckForestModel);
}
...
[[nodiscard]] std::expected<void, const char*> DeckPageController::CreateRootDeck(const std::string& DeckName,
    ...
    return Exception::TryCatchWrapper([&]() -> std::expected<void, const char*> {
